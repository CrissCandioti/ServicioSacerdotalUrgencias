...
public class HistoricoPedidos extends javax.swing.JInternalFrame {
    ...
    private void rbGuardianesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rbGuardianesActionPerformed
        if (jdate1.getDate() == null || jdate2.getDate() == null) {
            ...
            tablaHistoricos.getColumnModel().getColumn(6).setCellRenderer(new TableActionCellRenderer());
            tablaHistoricos.getColumnModel().getColumn(6).setCellEditor(new TableActionCellEditor(event));
        }
